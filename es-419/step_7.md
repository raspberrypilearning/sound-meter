...
Si estas siguiendo el camino de [introduccion a micro:bit](https://projects.raspberrypi.org/es-419/raspberrypi/path-name), puedes pasar al siguiente proyecto [Rastreador de sueño](https://projects.raspberrypi.org/es-419/projects/sleep-tracker).
...
![Rastreador de sueño](images/sleep-tracker.png)
...
Si quieres divertirte mas explorando micro:bit, entonces podrias probar cualquiera de [estos proyectos](https://projects.raspberrypi.org/es-419/projects?hardware%5B%5D=microbit).
